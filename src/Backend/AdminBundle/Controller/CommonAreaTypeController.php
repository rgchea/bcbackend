...
use Backend\AdminBundle\Form\CommonAreaTypeType;

/**
 * CommonAreaType controller.
 *
 */
class CommonAreaTypeController extends Controller
{
    ...
    protected function initialise()
    {
        ...
        $this->repository = $this->em->getRepository('BackendAdminBundle:CommonAreaType');
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('BackendAdminBundle:CommonAreaType:index.html.twig');
        ...
        foreach ($objects as $key => $entity)
        {
            ...
            foreach ($columns as $key => $column)
            {
                ...
                switch($column['name'])
                {
                    ...
                    case 'actions':
                        {
                            $urlEdit = $this->generateUrl('backend_admin_common_area_type_edit', array('id' => $entity->getId()));
                            $edit = "<a href='".$urlEdit."'><i class='fa fa-pencil-square-o'></i><span class='item-label'></span></a>&nbsp;&nbsp;";

                            $urlDelete = $this->generateUrl('backend_admin_common_area_type_delete', array('id' => $entity->getId()));
    ...
    /**
     * Creates a new CommonAreaType entity.
     *
     */
    public function newAction(Request $request)
    {
        ...
        return $this->render('BackendAdminBundle:CommonAreaType:new.html.twig', array(
            'entity' => $entity,
    ...
    /**
     * Finds and displays a CommonAreaType entity.
     *
     */
    public function showAction($entity)
    {
        ...
        return $this->render('backend_admin_common_area_type/show.html.twig', array(
            'entity' => $entity,
    ...
    /**
     * Displays a form to edit an existing CommonAreaType entity.
     *
     */
    public function editAction(Request $request, $id)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('backend_admin_common_area_type_edit', array('id' => $id));
        }

        return $this->render('BackendAdminBundle:CommonAreaType:edit.html.twig', array(
            'entity' => $entity,
    ...
    /**
     * Deletes a CommonAreaType entity.
     *
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        $form->handleRequest($request);
            ...
            $em = $this->getDoctrine()->getManager();
            $entity = $em->getRepository('BackendAdminBundle:CommonAreaType')->find($entity);
			...
			try{
                ...
                if ($e->getCode() == 0)
                {
                    ...
                    if (intval($e->getPrevious()->getCode()) == 23000)
                    {
                        ...
                        return $this->redirectToRoute('backend_admin_common_area_type_index');
                    }
                    else
                    {
                        throw $e;
    ...
    /**
     * Creates a form to delete a CommonAreaType entity.
     *
    ...
    private function createDeleteForm($entity)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('backend_admin_common_area_type_delete', array('id' => $entity->getId())))
            ->setMethod('DELETE')
            ->getForm()
            ;
    }
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('services')->flashSuccess($request);
            return $this->redirect($this->generateUrl('backend_admin_common_area_type_index'));
    ...
    /**
     * Creates a form to create a CommonAreaType entity.
     *
     * @param CommonAreaType $entity The entity
     *
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateForm($entity)
    {
        $this->get("services")->setVars('commonAreaType');
        $this->initialise();
        $form = $this->createForm(CommonAreaTypeType::class, $entity, array(
            'action' => $this->generateUrl('backend_admin_common_area_type_create'),
            'method' => 'POST',
            'role' => $this->role,
    ...
    /**
     * Creates a form to edit a CommonAreaType entity.
     *
     * @param CommonAreaType $entity The entity
     *
     * @return \Symfony\Component\Form\Form The form
    ...
    private function createEditForm($entity)
    {
        ...
        $form = $this->createForm(CommonAreaTypeType::class, $entity, array(
            'action' => $this->generateUrl('backend_admin_common_area_type_update', array('id' => $entity->getId())),
            'role' => $this->role,
            'userID' => $this->userLogged->getId(),
            'repository' => $this->em->getRepository('BackendAdminBundle:Complex'),
        ));
    ...
    /**
     * Edits an existing CommonAreaType entity.
     *
     */
