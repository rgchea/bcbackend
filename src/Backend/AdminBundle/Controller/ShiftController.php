...
use Backend\AdminBundle\Form\ShiftType;
...
class ShiftController extends Controller
{
    ...
    protected function initialise()
    {
        ...
        $this->repository = $this->em->getRepository('BackendAdminBundle:Shift');
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('BackendAdminBundle:Shift:index.html.twig');
        ...
        foreach ($objects as $key => $entity)
        {
            ...
            foreach ($columns as $key => $column)
            {
                ...
                switch($column['name'])
                {
                    ...
                    case 'hourFrom':
                        {
                            $responseTemp = $entity->getHourFrom();
                            break;
                        }
                    case 'hourTo':
                        {
                            $responseTemp = $entity->getHourTo();
                            break;
                        }

                    case 'weekDay':
                        {
                            $responseTemp = $entity->getWeekDay();
                            break;
                        }
                    case 'shiftDate':
                        {
                            $responseTemp = $entity->getShiftDate()->format('Y-m-d');
                            break;
                        }
                    
                    case 'overtime':
                        {
                            $responseTemp = $entity->getOvertime();
                            break;
                        }

                    case 'flexibleHours':
                        {
                            $responseTemp = $entity->getFlexibleHours();
                            break;
                        }

                    case 'flexitour':
                        {
                            $responseTemp = $entity->getFlexitour();
                            break;
                        }
                    ...
                    case 'actions':
                        {
                            $urlEdit = $this->generateUrl('backend_admin_shift_edit', array('id' => $entity->getId()));
                            $edit = "<a href='".$urlEdit."'><i class='fa fa-pencil-square-o'></i><span class='item-label'></span></a>&nbsp;&nbsp;";

                            $urlDelete = $this->generateUrl('backend_admin_shift_delete', array('id' => $entity->getId()));
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('BackendAdminBundle:Shift:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($entity)
    {
        ...
        return $this->render('backend_admin_shift/show.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction(Request $request, $id)
    {
        ...
        $entity = $em->getRepository('BackendAdminBundle:Shift')->find($id);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('backend_admin_shift_edit', array('id' => $id));
        }

        return $this->render('BackendAdminBundle:Shift:edit.html.twig', array(
            'entity' => $entity,
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        $form->handleRequest($request);
            ...
            $em = $this->getDoctrine()->getManager();
            $entity = $em->getRepository('BackendAdminBundle:Shift')->find($entity);
			...
			try{
                ...
                if ($e->getCode() == 0)
                {
                    ...
                    if (intval($e->getPrevious()->getCode()) == 23000)
                    {
                        ...
                        return $this->redirectToRoute('backend_admin_shift_index');
                    }
                    else
                    {
                        throw $e;
    ...
    private function createDeleteForm($entity)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('backend_admin_shift_delete', array('id' => $entity->getId())))
            ->setMethod('DELETE')
            ->getForm()
            ;
    }
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            $myRequest = $request->request->get('shift');
            //var_dump($myRequest);die;
            $em = $this->getDoctrine()->getManager();
            //var_dump($request->get('shift');die;
            ...
            $this->get('services')->flashSuccess($request);
            return $this->redirect($this->generateUrl('backend_admin_shift_index'));
    ...
    /**
     * Creates a form to create a Shift entity.
     *
     * @param Shift $entity The entity
     *
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateForm($entity)
    {
        $this->get("services")->setVars('shift');
        $this->initialise();
        $form = $this->createForm(ShiftType::class, $entity, array(
            'action' => $this->generateUrl('backend_admin_shift_create'),
            'method' => 'POST',
            'role' => $this->role,
    ...
    /**
     * Creates a form to edit a Shift entity.
     *
     * @param Shift $entity The entity
     *
     * @return \Symfony\Component\Form\Form The form
    ...
    private function createEditForm($entity)
    {
        ...
        $form = $this->createForm(ShiftType::class, $entity, array(
            'action' => $this->generateUrl('backend_admin_shift_update', array('id' => $entity->getId())),
            'role' => $this->role,
            'userID' => $this->userLogged->getId(),
            'repository' => $this->em->getRepository('BackendAdminBundle:Complex'),
            'locale' => $this->translator->getLocale()
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $this->get('services')->flashSuccess($request);
            return $this->redirect($this->generateUrl('backend_admin_shift_index', array('id' => $id)));
