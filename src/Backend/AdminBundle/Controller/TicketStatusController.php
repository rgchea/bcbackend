...
use Backend\AdminBundle\Form\TicketStatusType;
...
class TicketStatusController extends Controller
{
    ...
    protected function initialise()
    {
        ...
        $this->repository = $this->em->getRepository('BackendAdminBundle:TicketStatus');
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('BackendAdminBundle:TicketStatus:index.html.twig');
                    ...
                    case 'actions':
                        {
                            ...
                            $urlDelete = $this->generateUrl('backend_admin_ticket_status_delete', array('id' => $entity->getId()));
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('BackendAdminBundle:TicketStatus:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($entity)
    {
        ...
        return $this->render('backend_admin_ticket_status/show.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction(Request $request, $id)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('backend_admin_ticket_status_edit', array('id' => $id));
        }

        return $this->render('BackendAdminBundle:TicketStatus:edit.html.twig', array(
            'entity' => $entity,
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        $form->handleRequest($request);
            ...
            $em = $this->getDoctrine()->getManager();
            $entity = $em->getRepository('BackendAdminBundle:TicketStatus')->find($entity);
			...
			try{
                ...
                if ($e->getCode() == 0)
                {
                    ...
                    if (intval($e->getPrevious()->getCode()) == 23000)
                    {
                        ...
                        return $this->redirectToRoute('backend_admin_ticket_status_index');
                    }
                    else
                    {
                        throw $e;
    ...
    private function createDeleteForm($entity)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('backend_admin_ticket_status_delete', array('id' => $entity->getId())))
            ->setMethod('DELETE')
            ->getForm()
            ;
    }
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('services')->flashSuccess($request);
            return $this->redirect($this->generateUrl('backend_admin_ticket_status_index'));
