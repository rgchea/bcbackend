...
class ComplexSectorType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('complexSectorType',  null, array('label'=>"label_complex_sector_type", 'required'=>true))
            ;
        ...
        $builder->add('propertiesPerSection', null, ['required'=>true, 'mapped' => false ]);
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Backend\AdminBundle\Entity\ComplexSector',
