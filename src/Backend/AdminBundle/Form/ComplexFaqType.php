...
class ComplexFaqType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('question',  null, array('label'=>"label_question", 'required'=>true))
            ->add('answer',  null, array('label'=>"label_answer", 'required'=>true))
            ->add('orderList',  null, array('label'=>"label_order_list", 'required'=>true));
//            ->add('complex',  null, array('label'=>"label_complex", 'required'=>true))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Backend\AdminBundle\Entity\ComplexFaq',
            'role' => null,
            'repository' => null,
            'userID' => null,
